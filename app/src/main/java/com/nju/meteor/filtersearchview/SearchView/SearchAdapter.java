...
public class SearchAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(v==null){
            ...
            v = mLayoutInflater.inflate(R.layout.widget_search_view_list_item, parent, false);
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP){
            searchDrawable = mContext.getResources().getDrawable(R.drawable.ic_search, null);
            recentDrawable = mContext.getResources().getDrawable(R.drawable.ic_restore, null);

        } else {
            searchDrawable = mContext.getResources().getDrawable(R.drawable.ic_search);
            recentDrawable = mContext.getResources().getDrawable(R.drawable.ic_restore);
        }
        if(mIsFilterList) {
